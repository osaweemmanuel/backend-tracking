...
const parcelCreation = async (req, res) => {
    try {
        // Read data from body first, if not found, use query parameters
        const {
            senderName,
            senderGender,
            senderPhone,
        ...
        const queryParams = req.query; // Get query params for fallback
        const senderNameFromQuery = queryParams.senderName || senderName;
        const senderGenderFromQuery = queryParams.senderGender || senderGender;
        const senderPhoneFromQuery = queryParams.senderPhone || senderPhone;
        const senderNationalityFromQuery = queryParams.senderNationality || senderNationality;
        const receiverNameFromQuery = queryParams.receiverName || receiverName;
        const receiverPhoneFromQuery = queryParams.receiverPhone || receiverPhone;
        const receiverGenderFromQuery = queryParams.receiverGender || receiverGender;
        const receiverNationalityFromQuery = queryParams.receiverNationality || receiverNationality;
        const receiverEmailFromQuery = queryParams.receiverEmail || receiverEmail;
        const originFromQuery = queryParams.origin || origin;
        const weightFromQuery = queryParams.weight || weight;
        const destinationFromQuery = queryParams.destination || destination;
        const destinationLatitudeFromQuery = queryParams.destinationLatitude || destinationLatitude;
        const destinationLongitudeFromQuery = queryParams.destinationLongitude || destinationLongitude;
        const serviceTypeFromQuery = queryParams.service_type || service_type;
        const descriptionFromQuery = queryParams.description || description;
        const parcelNameFromQuery = queryParams.parcelName || parcelName;
        const deliveryDateFromQuery = queryParams.deliveryDate || deliveryDate;
        ...
        db.query(query, [
            ...
            userId,
            senderNameFromQuery,
            senderPhoneFromQuery,
            senderNationalityFromQuery,
            senderGenderFromQuery,
            receiverNameFromQuery,
            receiverPhoneFromQuery,
            receiverEmailFromQuery,
            receiverNationalityFromQuery,
            receiverGenderFromQuery,
            originFromQuery,
            weightFromQuery,
            destinationFromQuery,
            destinationLatitudeFromQuery,
            destinationLongitudeFromQuery,
            serviceTypeFromQuery,
            descriptionFromQuery,
            parcelNameFromQuery,
            deliveryDateFromQuery, // Notice that status is omitted, it defaults to 'in transit'
            imageUrl,
            imagePublicId
        ], (err, parcelResult) => {
            if (err) {
